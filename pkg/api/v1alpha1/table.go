...
func addPolicyReportToTable(table *metav1beta1.Table, polrs ...v1alpha1.PolicyReport) {
...
func addClusterPolicyReportToTable(table *metav1beta1.Table, cpolrs ...v1alpha1.ClusterPolicyReport) {
